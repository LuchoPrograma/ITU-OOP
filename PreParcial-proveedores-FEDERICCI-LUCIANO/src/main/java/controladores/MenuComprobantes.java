...
//        this.vistaMenu.getTipoCBX().addActionListener(this);
//        
//        this.vistaMenu.getDiaTBX().addActionListener(this);
//        this.vistaMenu.getMesTBX().addActionListener(this);
//        this.vistaMenu.getAnioTBX().addActionListener(this);
//        
//        this.vistaMenu.getImporteTotalTBX().addActionListener(this);
    ...
    public void crearComprobante(){
       ...
       try{
            ...
            for (Proveedor prov : proveedores){
                ...
                if (prov.getRazonSocial().equals(this.vistaMenu.getRazonSocialCMBX().getItemAt(0))){
                    nuevoRecibo.setProveedor(prov);
                }
//                else{
//                    throw new Exception("ERROR: No se encontró el proveedor.");                  
//                };
            }
