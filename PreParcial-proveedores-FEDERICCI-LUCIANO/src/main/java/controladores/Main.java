 ...
 */
public class Main {
    //Recordar forzar nombres de atributos(columnas) usando anotaciones. Tambien forzar en la clase hijo(recibo) el nombre para que corresponda a Comprobante para juntar todo en una tabla?
...
//        controlador.crearProveedor(prov3);
        ...
        MenuComprobantes menu = new MenuComprobantes();
    }
}
